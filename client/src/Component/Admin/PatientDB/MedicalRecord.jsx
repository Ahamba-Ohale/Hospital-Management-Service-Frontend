  ...
  return (
    <div className="patient-content__med">
        <div className="patient-content__top">
            ...
            <button type='button' className="patient-content__medre">New Entry</button>
        </div>
        
        <div className="patient-content__medd">
            <div className="patient-content__med1">
                <div className="patient-content__date">
                    <p><b>2nd, Feb 2024</b></p>
                </div>
                <div className="patient-content__right">
                    <p><b>Complaint:</b> Fever, Headache</p>
                    <p><b>Diagnosis:</b> Malaria, Hypertension</p>
                    <p><b>Treatment:</b> Surgery, Chemotherapy</p>
                    <p><b>Prescription:</b> Paracetamol, Amoxicillin, Ibuprofen</p>
                </div>
                ...
                <div className="patient-content__ico">
                    ...
                    <div><RiDeleteBin5Line size={20}/></div>
                </div>
            </div>
            <div className="patient-content__med1">
                <div className="patient-content__date">
